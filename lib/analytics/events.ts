...
export const PROFILE_EVENTS = {
  ...
  CHANGE_PASSWORD_CLICKED: '[Profile] Change Password Clicked',
  PASSWORD_CHANGED_SUCCESS: '[Profile] Password Changed Success',
  PASSWORD_CHANGE_FAILED: '[Profile] Password Change Failed',
